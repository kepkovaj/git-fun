...
SWIFT_CLASS("_TtC12multiples_ex11AppDelegate")
...
SWIFT_CLASS("_TtC12multiples_ex14ViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified numberTxt;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified playBtn;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified displayLbl;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified addBtn;
- (IBAction)onAddPressed:(UIButton * __null_unspecified)sender;
